...
//************************************
vector<double> pr_caculate(double eps, double init, double beta)
{
...
int main()
{
	...
	init_link();
	cout << "初始化链接关系成功..." << endl;
	auto re=pr_caculate(eps, 1.0 / NR_PAGE, NR_PAGE, beta);
